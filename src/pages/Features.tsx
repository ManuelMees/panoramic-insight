    ...
    <section className="pt-32 pb-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-white mb-6">Unsere Vorgehensweise</h1>
          <div className="relative">
            <div className="lg:flex lg:items-start lg:gap-8">
              {/* Image for larger screens */}
              <img
                src="https://cdn.prod.website-files.com/671e87107adf0a7e3c6a1bbf/673aeef41deed88e2fa38398_agilita%CC%88t_image.avif"
                alt="Design Thinking, Lean Startup, and Agile Process"
                className="hidden lg:block w-[700px] rounded-xl shadow-xl"
              />
              ...
              <img
                src="https://cdn.prod.website-files.com/671e87107adf0a7e3c6a1bbf/673aeef41deed88e2fa38398_agilita%CC%88t_image.avif"
                alt="Design Thinking, Lean Startup, and Agile Process"
                className="lg:hidden w-full mb-8 rounded-xl shadow-xl"
              />
